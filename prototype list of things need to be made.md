...
3. make a simple level which is divided with fighting enemies in arena place and some platforming
4. make a limit on how many times you can summon the support objects *done*
5. make so when you die it resets the game. *done*
6. make a door which only disappears when a requirement is met
